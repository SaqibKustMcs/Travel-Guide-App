    ...
    return Scaffold(
      bottomNavigationBar: BottomNavigationBar(
        ...
        items: const <BottomNavigationBarItem> [
          ...
          BottomNavigationBarItem(icon: ImageIcon(AssetImage('assets/images/Vector (18).png')),label: "Favouites"),
          BottomNavigationBarItem(icon:ImageIcon(AssetImage("assets/Icons/Vector (5).png")),label:"Alerts"),
