              ...
              child: Align(
                  ...
                  child: Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          Text('Custom Order',style:GoogleFonts.poppins(color: Colors.white,fontSize: 18,fontWeight: FontWeight.w500),),
                          Text('Budget:  \$12/hr',style: GoogleFonts.poppins(color: Colors.white,fontSize: 17,fontWeight: FontWeight.w400),),
                          Text('Start Date:  June 22, 2022',style: GoogleFonts.poppins(color: Colors.white,fontSize: 17,fontWeight: FontWeight.w400),),
                          Text(' End Date: June 28, 2022',style: GoogleFonts.poppins(color: Colors.white,fontSize: 17,fontWeight: FontWeight.w400),),
                          TextButton(
