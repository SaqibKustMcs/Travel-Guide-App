              ...
              child: Align(
                  ...
                  child: Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          Text('Custom Order',style:GoogleFonts.poppins(color: Colors.black,fontSize: 18,fontWeight: FontWeight.w500),),
                          Text('Budget:  \$12/hr',style: GoogleFonts.poppins(color: Colors.black,fontSize: 17,fontWeight: FontWeight.w400),),
                          Text('Start Date:  June 22, 2022',style: GoogleFonts.poppins(color: Colors.black,fontSize: 17,fontWeight: FontWeight.w400),),
                          Text(' End Date: June 28, 2022',style: GoogleFonts.poppins(color: Colors.black,fontSize: 17,fontWeight: FontWeight.w400),),
                          Row(
                            children: [
                              TextButton(
                                ...
                                'Accept',style: GoogleFonts.poppins(
                                  fontWeight: FontWeight.w200,fontSize: 17,color: Colors.white
                              ),
                              )),
                              SizedBox(
                                width: 20,
                              ...
                              TextButton(
                                ...
                                'Decline',style: GoogleFonts.poppins(
                                  fontWeight: FontWeight.w400,fontSize: 17,color: Color(0xff2C7976)
                              ),
                              )),
                            ],
                          )
